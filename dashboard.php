...
$_SESSION['srn']=$row['student_srn'];
$_SESSION['course']=$row['student_course'];
$_SESSION['section']=$row['student_sec'];
$_SESSION['semester']=$row['student_sem'];
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              ...
              <div class="alert alert-info text-center" role="alert">
                <?php
                $id=$_SESSION["course"].$_SESSION["semester"].$_SESSION["section"];
